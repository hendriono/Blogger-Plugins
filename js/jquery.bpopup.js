 ...
 * cookieClose: false // Used to create Cookie on exit
 * cookieExpire: 3600 // Sets Cookie expiration in seconds
...
-----------------------------------------------------------*/
    ...
    function close() {
		...
		if(o.cookieClose && $.cookie) {
			$.cookie("popup_seen_",'1',{expires: 30, path: "/"});
		}
    ...
    function getCenterPosition(s, a) {
        ...
        return [vertical < 20 ? 20 : vertical, horizontal < 20 ? 20 : horizontal];
    } 
  };
/*-----------------------------------------------------------
	Defualt Values - Private
-----------------------------------------------------------*/
  $.fn.bPopup.defaults = {
        amsl: 150, 
        appendTo: 'body',
